    ...
    return (
        <div className="timelineWrapper">
            <div className="time">
                ...
                <button className="buttonLink" onClick={handleOpenMatch}>Matchning</button>
            </div>
            <div className="time">
                <div className="dashedLine"></div>
                {openMatch && 
                    <div className="timeContent">
                        <p>Vår adoptionsprocess är främst fokuserat på den första steget av adoptionsprocessen; Att matcha rätt ägare med rätt hund. Via vårt noga framtagna matchningsverktyg kan privatpersoner enkelt identifiera hundar som passar deras befintliga livsstil och tidigare förmåga.</p>
            ...
            <div className="time">
                <div className="dot"></div>
                <button className="buttonLink" onClick={handleOpenAfterMatch}>Efter match</button>
            </div>
            <div className="time">
                <div className="dashedLine"></div>
                {openAfterMatch && <div className="timeContent">
                    <p>Om du har fått fram en eller flera matchningar innebär det att du med största sannolikhet kan vara en lämplig framtida ägare till de hundar du matchats med! Det är dock alltid upp till den nuvarande hundägaren att avgöra om den håller med om den bedömningen som vårt matchningsverktyg gjort och de kan vilja ställa kompletterande frågor. </p>
            ...
            <div className="time">
                <div className="dot"></div>
                <button className="buttonLink" onClick={handleOpenSign}>Skriva avtal</button>
            </div>
            <div>
                {openSign && <div className="timeContent">
                    ...
                    <ul>
                        ...
                        <li>Överlåtelse av uttustning</li>
                    </ul>

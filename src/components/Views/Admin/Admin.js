                    ...
                    <div>
                        ...
                        <div className="dogContainer">
                            ...
                            <div className="dogImageContainer">
                                <h5>Kiros</h5>
                                <div className="dogImageWrapper">
                                    <img src={kiros2.default} alt="Kiros" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Frodo</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Sheeba</h5>
                                <div className="dogImageWrapper">
                                    <img src={sheeba.default} alt="Sheeba" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Rocky</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Rupert</h5>
                                <div className="dogImageWrapper">
                                    <img src={rupert.default} alt="rupert" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Alexa</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Swallow</h5>
                                <div className="dogImageWrapper">
                                    <img src={swallow.default} alt="swallow" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Smiler</h5>
                                <div className="dogImageWrapper">
                                    <img src={smiler.default} alt="smiler" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Bumble bee</h5>
                                <div className="dogImageWrapper">
                                    <img src={bumblebee.default} alt="bumblebee" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Milo</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Susana</h5>
                                <div className="dogImageWrapper">
                                    <img src={susana.default} alt="susana" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Sally</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Dollar</h5>
                                <div className="dogImageWrapper">
                                    <img src={dollar.default} alt="dollar" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Jacek</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Stormy</h5>
                                <div className="dogImageWrapper">
                                    <img src={stormy.default} alt="stormy" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Czaber</h5>
                                <div className="dogImageWrapper">
                                    <img src={czaber.default} alt="czaber" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Lejk</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Budgie</h5>
                                <div className="dogImageWrapper">
                                    <img src={budgie.default} alt="budgie" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Bombaj</h5>
                                <div className="dogImageWrapper">
                                    <img src={bombaj.default} alt="bombaj" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Seat & Ibiza</h5>
                                <div className="dogImageWrapper">
                                    <img src={seatibiza.default} alt="seatibiza" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Fred</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Michael</h5>
                                <div className="dogImageWrapper">
                                    <img src={michael.default} alt="michael" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Dominique</h5>
                                <div className="dogImageWrapper">
                                    <img src={dominique.default} alt="dominique" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Iris</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Archie</h5>
                                <div className="dogImageWrapper">
                                    <img src={archie.default} alt="archie" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Mattias</h5>
                                <div className="dogImageWrapper">
                                    <img src={mattias.default} alt="mattias" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Shay</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Lady Grey</h5>
                                <div className="dogImageWrapper">
                                    <img src={ladygrey.default} alt="ladygrey" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Tuptus</h5>
                                <div className="dogImageWrapper">
                                    <img src={tuptus.default} alt="tuptus" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Mambo</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Carmen</h5>
                                <div className="dogImageWrapper">
                                    <img src={carmen.default} alt="carmen" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Byczek</h5>
                                <div className="dogImageWrapper">
                                    <img src={byczek.default} alt="byczek" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Leo</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Ruairi</h5>
                                <div className="dogImageWrapper">
                                    <img src={ruairi.default} alt="ruairi" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Daisy</h5>
                                <div className="dogImageWrapper">
                                    <img src={daisy2.default} alt="daisy2" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Kevin</h5>
                            ...
                            <div className="dogImageContainer">
                                <h5>Archie</h5>
                                <div className="dogImageWrapper">
                                    <img src={archie2.default} alt="archie2" className="dogImage"/>
                                </div>
                            </div>
                            <div className="dogImageContainer">
                                <h5>Sickan</h5>
                                <div className="dogImageWrapper">
                                    <img src={sickan.default} alt="sickan" className="dogImage"/>
                                </div>
                            </div>
                        </div>
                    </div>

...
const WizardParent = () => {
  ...
  const [filteredData, setFilteredData] = useState({ dogs: [] });
  ...
  const filterDogs = () => {
    ...
    setFilteredData(filterProblematik);
        ...
        <Step title="Ledarskap" description="Ledarskap">
          ...
          <div className="inputWrapper">
            <div className="inputContainer">
              ...
              />
              <div className="border"></div>
              <label className="radioLabelWizardLarge" htmlFor="mjukt">
                Jag är mjuk och och varsam i mitt umgänge med hundar. Det faller
                mig inte lika naturligt att vara bestämd och konsekvent.
              </label>
            </div>
            <div className="inputContainer">
              <input
              ...
              />
              <div className="border"></div>
              <label className="radioLabelWizardLarge" htmlFor="tydligt">
                Jag är rak och konsekvent i min hunduppfostran och skulle ha
                svårare att anpassa mig till en skygg och skör hund.
              </label>
            </div>
          </div>
        </Step>
